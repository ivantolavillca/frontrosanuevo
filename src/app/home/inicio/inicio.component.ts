...
import { MatInputModule } from '@angular/material/input'; // También se necesita para el <input>
...
@Component({
  ...
  templateUrl: './inicio.component.html',  // Asegúrate de que el nombre y la ruta sean correctos
...
chartVisitors: ApexOptions;
    ...
    ngOnInit(): void {
      ...
      //     });
      this.data = {
        visitors: { series: [{ data: [30, 40, 35, 50, 49, 60, 70] }] },
        conversions: { series: [{ data: [10, 20, 30, 40, 50, 60, 70] }] },
        // ... otros datos
    };
